            ...
            <Container>
                <div className="flex flex-col gap-7">
                    <div>
                        ...
                        <div className='rounded-3xl bg-secondary-25 border border-secondary-30 px-3 md:px-4 py-[10px] md:py-3 text-primary-10 font-medium leading-6 text-center w-fit mt-4 text-sm md:text-base'>(Available Monday to Saturday, 10 AM to 5:30 PM)</div>
                    </div>
